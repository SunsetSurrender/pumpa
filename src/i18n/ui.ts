...
const en = {
  ...
  about: {
    ...
    stats: [
      { n: '0', label: 'cookies or trackers' },
      { n: '3', label: 'unit systems, any currency' },
      { n: '100%', label: 'stored on your device' },
    ],
  ...
  guides: {
    ...
    introBody: 'No filler, no ads-dressed-as-advice. Each guide answers one real question with worked numbers, says honestly when the answer is “it depends”, and ends with something you can check on your own car — usually in about five minutes with the calculator.',
    filterLabel: 'Filter by topic',
    chart: {
      title: 'Running cost per 100 km',
      petrol: 'Petrol',
      evHome: 'EV — home charging',
      evAc: 'EV — public AC',
      evDc: 'EV — DC fast',
      caption: 'Worked example: a 6.5 L/100km petrol car at €1.80/L vs a 17 kWh/100km EV at three electricity prices.',
    },
    categories: { all: 'All', economy: 'Fuel economy', costs: 'Running costs' },
    readMore: 'Read →',
    crumb: 'Guides',
...
const it: Dict = {
  ...
  about: {
    ...
    stats: [
      { n: '0', label: 'cookie o tracker' },
      { n: '3', label: 'sistemi di unità, qualsiasi valuta' },
      { n: '100%', label: 'salvato sul tuo dispositivo' },
    ],
  ...
  guides: {
    ...
    introBody: 'Niente riempitivi, niente pubblicità travestita da consigli. Ogni guida risponde a una domanda vera con numeri alla mano, ammette onestamente quando la risposta è “dipende” e finisce con qualcosa che puoi verificare sulla tua auto — di solito in cinque minuti con il calcolatore.',
    filterLabel: 'Filtra per argomento',
    chart: {
      title: 'Costo di marcia ogni 100 km',
      petrol: 'Benzina',
      evHome: 'Elettrica — ricarica a casa',
      evAc: 'Elettrica — colonnina AC',
      evDc: 'Elettrica — rapida DC',
      caption: 'Esempio: un\'auto a benzina da 6,5 L/100km a 1,80 €/L contro un\'elettrica da 17 kWh/100km a tre prezzi dell\'elettricità.',
    },
    categories: { all: 'Tutte', economy: 'Consumi', costs: 'Costi di gestione' },
    readMore: 'Leggi →',
    crumb: 'Guide',
...
const es: Dict = {
  ...
  about: {
    ...
    stats: [
      { n: '0', label: 'cookies o rastreadores' },
      { n: '3', label: 'sistemas de unidades, cualquier moneda' },
      { n: '100%', label: 'guardado en tu dispositivo' },
    ],
  ...
  guides: {
    ...
    introBody: 'Sin relleno, sin publicidad disfrazada de consejo. Cada guía responde a una pregunta real con números concretos, admite honestamente cuándo la respuesta es «depende» y termina con algo que puedes comprobar en tu propio coche — normalmente en cinco minutos con la calculadora.',
    filterLabel: 'Filtrar por tema',
    chart: {
      title: 'Coste de uso por cada 100 km',
      petrol: 'Gasolina',
      evHome: 'Eléctrico — carga en casa',
      evAc: 'Eléctrico — AC público',
      evDc: 'Eléctrico — rápida DC',
      caption: 'Ejemplo: un gasolina de 6,5 L/100km a 1,80 €/L frente a un eléctrico de 17 kWh/100km con tres precios de electricidad.',
    },
    categories: { all: 'Todas', economy: 'Consumo', costs: 'Costes de uso' },
    readMore: 'Leer →',
    crumb: 'Guías',
...
const toolIt: typeof toolEn = {
  ...
  preparingPdf: 'Preparo il tuo report…',
...
const toolEs: typeof toolEn = {
  ...
  preparingPdf: 'Preparando tu informe…',
